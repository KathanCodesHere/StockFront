...
const slides = [
  {
    img: hero1,
    title: "Elevate Your Wealth",
    highlight: "OctaBroking:",
    subtitle: "Your Partner in Smart Wealth Creation",
    desc: "Get clear guidance, simple tools, and smart strategies to grow your wealth—step by step, with confidence.",
    buttonText: "Explore the Experience",
    buttonLink: "#discover",
  },
  {
    img: hero2,
    title: "Trade Intelligently",
    highlight: "Everything Starts",
    subtitle: "With Smart Strategy",
    desc: "Unlock AI-driven alerts, pro insights, and a deep educational hub to stay ahead in every trade.",
  ...
  },
  {
    ...
    desc: "Never miss an opportunity. Track trends, receive alerts, and mCatch every opportunity with real-time alerts, trend tracking, and seamless performance monitoring.",
